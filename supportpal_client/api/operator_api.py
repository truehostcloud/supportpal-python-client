...
class OperatorApi:
    ...
    def _get_operator_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/user/operator/{id}',
    ...
    def list_operators(
        self,
        active: Annotated[Optional[StrictInt], Field(description="Filter by active status: 1 = active, 0 = inactive")] = None,
        email: Annotated[Optional[StrictStr], Field(description="Search for operators by email")] = None,
        ...
        :param active: Filter by active status: 1 = active, 0 = inactive
        :type active: int
        :param email: Search for operators by email
        :type email: str
        :param start:
        :type start: int
        :param limit:
