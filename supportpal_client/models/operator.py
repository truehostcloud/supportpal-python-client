...
class Operator(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "firstname", "lastname", "email", "email_verified", "active", "organisation_id", "organisation_access_level", "country", "language_code", "timezone", "avatar", "created_at", "updated_at", "formatted_name", "phonenumbers", "groups"]
